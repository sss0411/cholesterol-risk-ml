...
if st.button("Predict risk"):
    ...
    # ---- SAFELY map probability to CHOL = 1 ----
    classes = model.classes_
    risk_label = 1  # CHOL = 1 → elevated cholesterol
    risk_index = list(classes).index(risk_label)
    ...
    # Thresholds adapted for class imbalance (~12%)
    if probability >= 0.20:
